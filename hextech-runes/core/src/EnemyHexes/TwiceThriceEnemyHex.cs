...
internal sealed class TwiceThriceEnemyHex : HextechEnemyHexEffect
{
	internal override MonsterHexKind Kind => MonsterHexKind.TwiceThrice;
	...
	internal override decimal ModifyPlayerAttackEnergyCostMultiplier(HextechEnemyHexContext context, CardModel card, decimal originalCost)
	{
		...
		return nextAttackIndex % 3 == 0 ? 2m : 1m;
	}
}
